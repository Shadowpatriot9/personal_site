...
function NFI() {
    const { project } = useProjectMetadata('nfi');
    const projectTitle = project?.title || 'NFI';
    const projectDescription = project?.description || 'Rocket Propulsion System';

    useEffect(() => {
        logger.pageView(`${projectTitle} Project Page`, {
            project: project?.id || 'nfi',
            projectType: projectDescription,
            dateOfOrigin: '10/2020',
            status: 'Discontinued (05/2021)'
        });
                ...
                <div className="container">
                    ...
                    <div className="grid-1">
                        ...
                        <section className="section" id="brief">
                            <h3> Description: </h3>
                            <p><span>(Date of origin: 10/2020)</span></p>
                            <h4>
